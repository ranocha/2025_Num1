...
md"""
`Float64` ist für die Grundlagen der Numerik typischerweise der Standard-Zahlentyp, mit dem wir arbeiten. In C, C++ und MATLAB ist dies `double` (und der Standard wenn in MATLAB nichts anderes angegeben ist).
"""
...
function plot_floating_point_precision(T)
	...
	lines!(ax_rel, [xmin, xmax], [eps(T), eps(T)];
		   linestyle = :dot, color = Makie.wong_colors()[2],
...
manifest_format = "2.0"
project_hash = "eb19974a2917ade5981170d207c20400aaf58a08"
