...
# ╔═╡ 4dc09548-17fe-4bbe-bf83-a138fd01e264
using SparseArrays

# ╔═╡ 4c0fa33a-ab47-4611-943d-b46a14784d14
using BandedMatrices

# ╔═╡ cac4f4f8-7576-419c-9125-b84b34e226db
using BenchmarkTools

# ╔═╡ 8f627a47-5cf5-4f36-8b10-22bbf60a0688
begin
	using CairoMakie
...
# ╔═╡ 7dddd6ba-c3f3-47ff-8428-69791d33adb7
using LaTeXStrings
...
function get_matrix(::Type{Matrix}, n)
	A = diagm(-1 => ones(n - 1),
		      0  => 2 * ones(n),
		      +1 => ones(n - 1))
	return A
...
function get_matrix(::Type{SparseMatrixCSC}, n)
...
function compare_performance()
	...
	for T in types
		...
		scatter!(ax, ns, runtimes; label = "$T")
...
manifest_format = "2.0"
project_hash = "b994419db9ba48a563f529d9aab85b5c550ce764"
...
git-tree-sha1 = "3203bde0e9793698e0f23862bc668a815261409c"
...
git-tree-sha1 = "32bd8c53cdc46216887405a1e7e4efce01bc1c6a"
